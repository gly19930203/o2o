var evaluateinfo = {
	...
	//获取平均分
	getAPIasync("/Course/GetEvaluationTagScore","pCourseId="+pCourseId,"get",function(e){
		if(e){
	...
	//获取标签
	getAPIasync("/Course/GetEvaluationTagEvaluate","pCourseId="+pCourseId,"get",function(e){
		if(e){
...
function Pullrefresh(){
	require(['h5/pullrefresh2'], function(pullrefresh){
		pullrefresh.doRefresh({
			debug: false,		 // 模拟真实请求数据，否则会出现ajax跨域，正式使用中请去h5.js中删除debug代码
			url: API_HOST+'/Course/GetCourseEvaluateList',  // 必填，ajax加载数据请求的地址
