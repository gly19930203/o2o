...
Progress.prototype= {
    init:function (init) {
        ...
        init.lineWidth !== undefined?
            this.lineWidth = init.lineWidth : this.lineWidth =w/140;

        //判断宽高较小者
        this.wh = width>height?height:width;

        //设置圆的半径，默认为宽高较小者
        init.circleRadius>0&&init.circleRadius<=this.wh/2.1-this.lineWidth/2.1?
            this.circleRadius = init.circleRadius:this.circleRadius = this.wh/2.1-this.lineWidth/2.1;
        ...
        init.fontSize !==undefined?
            this.fontSize = init.fontSize:this.fontSize=w/20;
